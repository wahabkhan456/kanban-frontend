...
export default function AddColumn({ handleClick, newVal, isEdit, handleUpdate }) {
    ...
    return (
        <div><div className='py-3 px-3 w-72 rounded-lg bg-[rgb(14,17,23)] hover:border border-red-500 flex items-center space-x-3 cursor-pointer' onClick={() => document.getElementById('my_modal_3').showModal()}>
            ...
            <dialog id="my_modal_3" className="modal">
                <div className="modal-box">
                    ...
                    <input placeholder='Title' className="py-3 px-2 mt-3 bg-[rgb(14,17,23)] w-full placeholder-white rounded-lg" value={title} onChange={(e) => setTitle(e?.target?.value)} />
