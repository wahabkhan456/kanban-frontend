        ...
        <div>
            <dialog id="my_modal_4" className="modal">
                <div className="modal-box">
                    ...
                    <input placeholder='Title' className="py-3 px-2 mt-3 bg-[rgb(14,17,23)] w-full placeholder-white rounded-lg" value={row?.title} onChange={(e) => setRow({ title: e?.target?.value, description: row.description })} />
                    <textarea placeholder='Description' className="py-3 px-2 mt-3 bg-[rgb(14,17,23)] w-full placeholder-white rounded-lg" value={row?.description} onChange={(e) => setRow({ title: row?.title, description: e?.target?.value })} rows={8} />
